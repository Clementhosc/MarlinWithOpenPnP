...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 50*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define POWER_MONITOR_VOLTAGE   // Monitor the system voltage
  ...
  #define POWER_MONITOR_VOLTS_PER_VOLT  1  // Input voltage to the MCU analog pin per volt - DO NOT apply more than ADC_VREF!
